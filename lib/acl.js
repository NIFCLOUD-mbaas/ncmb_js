...
var Acl = module.exports = function(ncmb) {
  ...
  Acl.prototype.setUserWriteAccess   = function(user, allowed) {
    if(!user.objectId) throw new Errors.NoObjectIdError();
  ...
  Acl.prototype.get = function(target, type){
    if(typeof target !== "string") throw new Errors.InvalidArgumentError();
    if(typeof type !== "string") throw new Errors.InvalidArgumentError();
    if(type !== "read" && type !== "write") throw new Errors.InvalidArgumentError();
