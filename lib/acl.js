...
var Acl = module.exports = function(ncmb) {
  var reserved = [
    "set", "setReadAccess", "setWriteAccess", "setPublicReadAccess", "setPublicWriteAccess",
    "setUserReadAccess", "setUserWriteAccess", "setRoleReadAccess", "setRoleWriteAccess", "toJSON"];
  ...
  function Acl(permissions) {
    if(permissions) {
      Object.keys(permissions).forEach(function(key){
        if(isReserved(key)){
          throw new errors.UnReplaceableKeyError(key + "is reserved");
        }
