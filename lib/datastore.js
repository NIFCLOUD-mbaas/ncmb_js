    ...
    var Data = (function(){
          ...
          if(attrs.hasOwnProperty(attr)){
            if(!isReserved(attr)){
              ...
              if (attrs[attr] instanceof Date) {
                this[attr] = {__type: "Date", iso: attrs[attr].toJSON()};
                continue;
              }
      ...
      Data.prototype.save = function(callback){
        for(var key in this){
          ...
          checkUnsavedObject(this, key, this[key]);
        }
      ...
      var checkUnsavedObject = function(obj, key, value){
        if (value instanceof Date) {
          obj[key] = {__type: "Date", iso: value.toJSON()};
          return;
        }
        ...
        if(!obj.setPointerList) obj.setPointerList = [];
        var element = {key: key, object: value}
        obj.setPointerList.push(element);
        return;
      };
