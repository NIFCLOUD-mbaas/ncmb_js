...
var Geolocation = module.exports = function(ncmb){
    ...
    function Geolocation(lat, lng) {
        var pos = (lng != null && Geolocation.validate(lat, lng)) ||
                  (lat && lat !== null && Array.isArray(lat) && lat.length === 2 && Geolocation.validate(lat[0], lat[1])) ||
                  (lat && lat !== null && typeof lat === 'object' && Object.keys(lat).length === 2 && lat.latitude && lat.longitude && Geolocation.validate(lat.latitude, lat.longitude)) ||
