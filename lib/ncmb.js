...
var NCMB = module.exports = (function(){
  ...
  function NCMB (apikey, clientkey, config){
    ...
    Object.setPrototypeOf(this,{
      User: require("./user")(this),
      Role: require("./role")(this),
      File: require("./file")(this),
      Push: require("./push")(this),
      Installation: require("./installation")(this),
      Script: require("./script")(this),
      Acl: require("./acl")(this),
      GeoPoint: require("./geopoint")(this),
      Relation: require("./relation")(this),
