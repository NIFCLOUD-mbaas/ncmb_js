...
var NCMB = module.exports = (function(global){
  ...
  NCMB.prototype.setItem = function(key, value){
    try{
      localStorage.setItem(makeStoragePath(key, this.apikey), value);
    }catch(err){
      throw err;
    }
  };

  NCMB.prototype.getItem = function(key){
    return localStorage.getItem(makeStoragePath(key, this.apikey));
  };

  NCMB.prototype.removeItem = function(key){
