...
var Query = module.exports = (function(){
  ...
  Query.prototype.in                   = function(key, value){
    if(!Array.isArray(value)) throw new this.ncmb.Errors.InvalidArgumentError();
  ...
  Query.prototype.select = function(key, subkey, subquery){
    ...
    if(!subquery._className) throw new this.ncmb.Errors.InvalidArgumentError();
    var className = null;
  ...
  Query.prototype.relatedTo = function(object, key){
    ...
    if(!object.className)       throw new this.ncmb.Errors.InvalidArgumentError();
    if(!object.objectId){
  ...
  Query.prototype.fetchById = function(id, callback){
    ...
    return this.ncmb.request({
      ...
      if(callback) return callback(null, new Klass(obj));
