  ...
  return new Promise(function(resolve, reject){
    var _callback = function(err, res){
      if(err && err.response && err.response.error){
        //remove property of error to print or catch error
        ...
        // use code, error property when print log with alert(JSON.stringify())
        err.response.error.code = err.response.body.code;
        err.response.error.error = err.response.body.error;
        // use message property when print log with console.log()
