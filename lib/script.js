...
var Script = module.exports = function(ncmb){
  ...
  */
  Script.set = function(header){
    ...
    this.reservedHeaders.forEach(function(key){
      if(header[key]) throw new Errors.InvalidRequestHeaderError(key + " is reserved header.");
    });
    this.req.header = merge({}, this.req.data, header);
    return this;
  }
  ...
  */
  Script.data = function(data){
    ...
    this.req.data = merge({}, this.req.data, data);
    return this;
  }
  ...
  */
  Script.query = function(query){
    ...
    this.req.query = merge({}, this.req.query, query);
    return this;
  }
