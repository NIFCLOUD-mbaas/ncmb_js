...
* Scriptの実行を扱うクラスです。
*
* 実行可能なExecutableインスタンスを生成し、メソッドチェインでヘッダ、ボディ、クエリを付与して使用します。
*
...
var Script = module.exports = function(ncmb){
  ...
  var Executable = (function(){;
    ...
    /**
    * Executableインスタンスに対してチェインしてリクエストヘッダを付与するメソッドです。
    *
    * @method set
    * @param  {Object}     header リクエストヘッダを示すJSON形式のオブジェクト
    * @return {Executable} this   引数のリクエストヘッダが付加された実行可能インスタンス
    */
    Executable.prototype.set = function(header){
      ...
      this._header = merge({}, this._header, header);
      return this;
    };

    /**
    * Executableインスタンスに対してチェインしてリクエストボディを付与するメソッドです。
    *
    * @method data
    * @param  {Object}     body リクエストボディを示すJSON形式のオブジェクト
    * @return {Executable} this 引数のリクエストボディが付加された実行可能インスタンス
    */
    ...
    /**
    * Executableインスタンスに対してチェインしてクエリストリングを付与するメソッドです。
    *
    * @method query
    * @param  {Object}     query クエリストリングを示すJSON形式のオブジェクト
    * @return {Executable} this  引数のクエリストリングが付加された実行可能インスタンス
    */
