...
*
* ※注意：以下のMethodsメソッド一覧には対応しているメソッド名がリンクとして記載されています。メソッドには２種類のメソッドがあります。
* 以下のリンク記載とメソッドの種類をご確認してから、メソッドの詳細をご確認ください。
*   - NCMB.クラス名#メソッド名: インスタンス用メソッド Instance method
...
*        user.login();
*        ```
*   - NCMB.クラス名Constructor#メソッド名: クラスのStatic methodスタティックメソッド
